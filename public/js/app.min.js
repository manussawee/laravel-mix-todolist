...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Home_vue__ = __webpack_require__(7);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_AddTodoItem_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_AddTodoItem_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_AddTodoItem_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_TodoItem_vue__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_TodoItem_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_TodoItem_vue__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/todo').then(function (res) {
  ...
  methods: {
    addTodo: function addTodo(data) {
      ...
      if (data === '') return;
      this.isLoading = true;
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/todo', {
        title: data
      }).then(function (res) {
        _this2.todos.push(res.data.todo);
    ...
    onRemove: function onRemove(data) {
      ...
      this.isLoading = true;
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.delete('/todo', {
        params: {
          id: data.id
        }
      }).then(function (res) {
        _this3.todos = _this3.todos.filter(function (todo) {
    ...
    onEdit: function onEdit(data) {
      ...
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.put('/todo', data).then(function (res) {
        _this4.todos[idx].title = data.title;
  ...
  components: {
    AddTodoItem: __WEBPACK_IMPORTED_MODULE_0__components_AddTodoItem_vue___default.a,
    TodoItem: __WEBPACK_IMPORTED_MODULE_1__components_TodoItem_vue___default.a
  }
});
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "container", staticStyle: { "padding-top": "32px" } },
    [
        ...
        _c("div", { staticClass: "card" }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("AddTodoItem", {
                attrs: { todoInput: _vm.todoInput },
                on: { onAdd: _vm.addTodo }
              }),
              _vm._v(" "),
              _c("TodoItem", {
                attrs: { todos: _vm.todos },
                on: { onEdit: _vm.onEdit, onRemove: _vm.onRemove }
              })
            ],
            1
          )
...
Component.options.__file = "resources\\assets\\js\\components\\AddTodoItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-61108193", Component.options)
  } else {
    hotAPI.reload("data-v-61108193", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-61108193", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setEditIndex: function setEditIndex(index) {
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.todos_, function(item, index) {
      return _c(
        "div",
                    ...
                    directives: [
                      {
                        ...
                        rawName: "v-model",
                        value: _vm.editInput,
                        expression: "editInput"
                      }
                    ],
                    domProps: { value: _vm.editInput },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.editInput = $event.target.value
                      }
                    }
                  }),
                  _vm._v(" "),
